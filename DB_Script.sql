...
/****** Object:  Database [TechSolutionsDB]    Script Date: 2023/11/14 23:25:53 ******/
CREATE DATABASE [TechSolutionsDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TechSolutionsDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\TechSolutionsDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TechSolutionsDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\TechSolutionsDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [TechSolutionsDB] SET AUTO_CLOSE OFF 
GO
...
ALTER DATABASE [TechSolutionsDB] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [TechSolutionsDB] SET RECOVERY FULL 
GO
